      ...
      try {
        ...
        const networkMap = {
          ...
          Base_Mainnet: {
            ...
            rpcUrls: ["https://base-mainnet.g.alchemy.com/v2/o9t9nCPDgoErA9_nMlxHY5sTXzHpcpdl"],
        ...
        await window.ethereum.request({
          ...
          params: [networkMap.Base_Mainnet],
        });
...
export const connectedChain = async () => {
  try {
    ...
    if (chain === CONFIG.CHAINID) {
      ...
      toast.error(`Please change to Mumbai Chain Network`);
